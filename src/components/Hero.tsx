            ...
            <div className="relative rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-2xl shadow-orange-500/5">
              ...
              <div className="aspect-[4/5] bg-zinc-800 relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center -z-10">
                  <p className="text-zinc-600 font-mono text-sm">{t('hero_video_fallback')}</p>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-6 rtl:-bottom-6 -left-6 rtl:-right-6 rtl:left-auto bg-zinc-900 border border-zinc-700 p-4 rounded-xl shadow-xl backdrop-blur-md hidden sm:block">
              <div className="text-xs text-zinc-400 font-medium uppercase tracking-wider mb-1">{t('hero_score_label')}</div>
